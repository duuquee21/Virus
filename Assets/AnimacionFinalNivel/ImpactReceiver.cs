...
public class ImpactReceiver : MonoBehaviour
{
    ...
    [Tooltip("Permite que unos objetos se sacudan m�s que otros (1 = normal)")]
    ...
    void LateUpdate() // Usamos LateUpdate para que ocurra DESPU�S del movimiento normal
    {
        if (fuerzaActual > 0.01f)
        {
            ...
            // Esto permite que el objeto siga su ruta original pero con la vibraci�n encima
