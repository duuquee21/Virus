...
public class LevelTransitioner : MonoBehaviour
{
    ...
    public float suavizadoEscala = 8f; // Un poco m�s r�pido para el impacto

    [Header("Configuraci�n de Impacto Seco")]
    [Tooltip("Fuerza del primer golpe")]
    public float intensidadImpacto = 0.5f;
    [Tooltip("Qu� tan r�pido se detiene la vibraci�n (m�s alto = m�s seco)")]
    ...
    private IEnumerator ExecuteFullTransition()
    {
        ...
        if (mapaVisual)
        {
            ...
            // --- NUEVA CONEXI�N: Avisar al ManualSetCycler ---
        ...
        if (nextMap < LevelManager.instance.mapList.Length)
        {
            ...
            // === CACHÉ: Reutilizar planeta en lugar de buscar de nuevo ===
            if (planeta != null) planeta.isInvulnerable = true;
            LevelManager.instance.currentSessionInfected = 0;
        }

        // --- FASE 3: ESPERA T�CNICA ---
        ...
        // empezar� a encogerse justo en este frame, coincidiendo con el Shake.
