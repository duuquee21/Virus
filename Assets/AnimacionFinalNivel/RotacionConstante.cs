...
// 🎮 AÑADIDO: ISelectHandler, IDeselectHandler (para moverse) y ISubmitHandler (para pulsar con el mando)
public class HexagonoInteractivoFinal : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
{
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        {
            EventSystem.current.SetSelectedGameObject(null); // Limpiamos selección del mando
        }
        ActivarEfectosHover();
    }
    ...
    // ==========================================
    // ⚙️ MÉTODOS INTERNOS Y CORRUTINAS
    // ==========================================
