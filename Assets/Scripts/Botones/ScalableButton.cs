...
public class ScalableButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        // L�gica de compra (Ejemplo simple)
    ...
    private void ExecutePurchase()
    {
        ...
        // Animaci�n de �xito (Fase 4)
        transform.DOScale(normalScale, animationDuration).SetEase(Ease.OutBounce);
        if (infoText != null) infoText.gameObject.SetActive(false);

        Debug.Log("Comprado!");
        // Aqu� llamar�as a tu sistema de part�culas o sonidos
    }
    ...
    {
        // Sustituir por tu l�gica real de dinero
        return true;
    }

    // --- M�TODOS PARA ESCALABILIDAD FUTURA ---
    protected virtual void OnHoverEnterEffect()
    {
        // Aqu� podr�s a�adir sonidos o part�culas sin romper la l�gica base
    }
}