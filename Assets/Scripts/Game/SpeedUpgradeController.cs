...
public class SpeedUpgradeController : MonoBehaviour
{
    ...
    // M�todo para sumar un nivel (+0.5f a la velocidad)
    ...
    void ApplySpeed()
    {
        ...
        // Aseg�rate de que en Guardado.instance.speedMultiplier el valor inicial sea 1f
        ...
        {
            // IMPORTANTE: Solo enviamos el c�lculo final
